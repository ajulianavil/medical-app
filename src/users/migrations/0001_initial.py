    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(choices=[('admin', 'admim'), ('médico', 'médico'), ('investigador', 'investigador')], max_length=100)),
                ('description', models.TextField(blank=True, default='', max_length=600, verbose_name='Description')),
                ('userid', models.AutoField(primary_key=True, serialize=False)),
                ('last_login', models.DateTimeField(blank=True, null=True)),
                ('useremail', models.CharField(blank=True, max_length=100, null=True, unique=True)),
