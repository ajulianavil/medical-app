...
urlpatterns = [
    ...
    path("reporte/graficos/<int:consultaid>", views.reporte_graficos, name="reporte_graficos"),
    path('chart-data/<int:idreporte_id>/<str:nombreMedicion>/<str:ga>/<int:consultaid>', views.chart_data_view, name='chart_data'),
