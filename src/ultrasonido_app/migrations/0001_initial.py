...
import ultrasonido_app.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedulapac', models.IntegerField(blank=True, db_column='cedulaPac', null=True, unique=True, validators=[ultrasonido_app.validators.val_cedulapac])),
        ...
        migrations.CreateModel(
            name='Usuarioexterno',
            fields=[
                ('cedulaext', models.IntegerField(primary_key=True, serialize=False, validators=[ultrasonido_app.validators.val_cedulaext])),
                ...
                ('institutionid', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='ultrasonido_app.institucion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospitalid', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='ultrasonido_app.hospital', verbose_name='Hospitales')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tipo_medicion', models.OneToOneField(db_column='idTipoMedicion', on_delete=django.db.models.deletion.CASCADE, to='ultrasonido_app.tipomedicion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idPaciente', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='ultrasonido_app.paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idpac', models.ForeignKey(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='ultrasonido_app.paciente')),
                ('idreporte', models.OneToOneField(default='', on_delete=django.db.models.deletion.SET_DEFAULT, to='ultrasonido_app.reporte')),
                ('medConsulta', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='ultrasonido_app.personalsalud')),
            ],
            options={
